...
public class CivilianDirectory {
   ...
   public CivilianDirectory() {
    ...
    public Civilian createCivilian(String firstName, String lastName, String age, String sex, UserAccount userAccount, String username, String contact, String address){

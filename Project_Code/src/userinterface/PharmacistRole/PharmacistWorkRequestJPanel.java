 ...
 * @author prajw
 */
public class PharmacistWorkRequestJPanel extends javax.swing.JPanel {

    /**
     * Creates new form PharmacistWorkRequestJPanel
     */
    PharmacyOrganization pharmaOrganization;
    JPanel userProcessContainer;
    MedicineWorkRequest request;
    EcoSystem system;
    public PharmacistWorkRequestJPanel(JPanel userProcessContainer, MedicineWorkRequest request, EcoSystem system, PharmacyOrganization pharmaOrganization) {
        initComponents();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        request.setMessage(deliveryMan + "is assignment for delivery.");
        
        String sender = request.getSender().toString();
        System.out.println("Sender ----->"+sender);
//        System.out.println(groceriesOrganization.getWorkQueue().getWorkRequestList());
        for(WorkRequest all_requests : pharmaOrganization.getWorkQueue().getWorkRequestList()){

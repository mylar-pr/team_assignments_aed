...
public class GroceriesWorkRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 273, -1, -1));
        ...
        add(submitJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(428, 273, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 430, 120));
...
//            System.out.println(all_requests.getSender().toString());
            if(all_requests.getSender().toString().equalsIgnoreCase(sender)){
                all_requests.setMessage(deliveryMan + "is assignment for delivery.");
            }
        }

...
public class CheckStatusJPanel extends javax.swing.JPanel {
    ...
    private String wardType = "pending";
             ...
             if (request instanceof AssignWardWorkRequest) {
                    if(((AssignWardWorkRequest) request).getUsername().equalsIgnoreCase(userAccount.getUsername())){
                        ...
                        if(((AssignWardWorkRequest) request).getWardAssigned().equals("Yes")){
                            message = ("Important!! you have been tested positive and assigned a " + ((AssignWardWorkRequest) request).getWardType());
                            wardType = ((AssignWardWorkRequest) request).getWardType();
                            populateRequestTable();
...
//                 String to = "HospitalAdmin";
//                String subject = "Important! Ward assigned.";
//             String user = "paipramoddbz@gmail.com";
//             String pass = "";   
//             String message = " Hello " + ". " + msg + ". " + "Your patient ID is 0056748, which will be used upon arrival";
//                         

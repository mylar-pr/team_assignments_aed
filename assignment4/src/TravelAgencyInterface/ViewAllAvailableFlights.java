 ...
 * @author dileeprholla
 */
public class ViewAllAvailableFlights extends javax.swing.JPanel {

    /**
     * Creates new form ViewAllAvailableFlights
     */
    JPanel right_Panel;
    ...
    public ViewAllAvailableFlights(JPanel right_Panel, AirlinerDirectory airlinerDirectory,Airliner airliner,BookingDirectory bookingList) {
        initComponents();
    ...
    public void Populate_Table() {
        ...
        DefaultTableModel model = (DefaultTableModel) tbl_AllFlights.getModel();
        model.setRowCount(0);
        for (Flights f : AllflightsSchedule) {
    ...
    private void initComponents() {
        ...
        tbl_AllFlights = new javax.swing.JTable();
        jLabel1 = new javax.swing.JLabel();
        btnBook = new javax.swing.JButton();

        tbl_AllFlights.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tbl_AllFlights);
    ...
    private void btnBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookActionPerformed
        ...
        int selectrow = tbl_AllFlights.getSelectedRow();
        if (selectrow < 0) {
            JOptionPane.showMessageDialog(null, "Please select a flight to book");

        } else {

            Flights f = (Flights) tbl_AllFlights.getValueAt(selectrow, 1);
            System.out.println("flight semdimb is"+ f);
            TA_CustomerSeatBooking tabs = new TA_CustomerSeatBooking(right_Panel, f, airlinerDirectory,bookingList);
    ...
    private javax.swing.JTable tbl_AllFlights;

...
//        this.deliveryOrganization = (DeliveryOrganization)organization;
    ...
    private void initComponents() {
        ...
        manageDeliveryMenBtn.setBackground(new java.awt.Color(0, 0, 51));
        manageDeliveryMenBtn.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        manageDeliveryMenBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(manageDeliveryMenBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 230, 50));

        createDeliveryMenBtn1.setBackground(new java.awt.Color(0, 0, 51));
        createDeliveryMenBtn1.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        createDeliveryMenBtn1.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(createDeliveryMenBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 230, 50));
